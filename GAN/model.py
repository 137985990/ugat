...
# ====== LSTM-based GAN Generator for Time Series ======
class GANGenerator(nn.Module):
    """
    自编码器结构的生成器：输入mask后的[batch, channels, time]，输出补全[batch, channels, time]
    可用Conv1d/LSTM/Transformer等替换为更复杂结构
    """
    def __init__(self, in_channels, out_channels, seq_len, hidden_dim=128):
        super().__init__()
